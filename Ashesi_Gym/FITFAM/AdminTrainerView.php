    ...
    <div class="maincontent">
        ...
        <div>
            <div>
                ...
                <button onclick="openModal()" > Add Trainers</button>
            </div>
            <div>
...
<table id="coachTable">
    ...
    <tbody>
        <tr>
            ...
            <td>2023-01-01</td>
            <td>2024-01-01</td>
            <td><button onclick="editCoach()">Edit</button></td>
        </tr>
        <tr>
            <td>John Doe</td>
            <td>12345</td>
...
<div id="myModal" class="modal">
    <div class="modal-content">
        ...
        <h4>Add Coach</h4>
        <form id="dataEntryForm" method="post" action="process_trainer_add.php">
            <input type="text" id="dataField" name="coach_id" required placeholder="coachID" class="create-input">
            <br>
            <input type="text" id="dataField" name="first_name" required placeholder="firstName" class="create-input">
            <br>
            <input type="text" id="dataField" name="last_name" required placeholder="lastName" class="create-input">
            <br>
            <input type="text" id="dataField" name="tel_no" required placeholder="telno" class="create-input">
            <br>
            <input type="text" id="dataField" name="email" required placeholder="email" class="create-input">
            <br>
            <input type="text" id="dataField" name="dob" required placeholder="dob" class="create-input">
            <br>
            <input type="text" id="dataField" name="wage" required placeholder="wage" class="create-input">
            <br>
            <!-- Close button -->
...
<script>
    ...
    <script src ="fetch_trainers.js"></script>
    <script>
        ...
        const deleteCoach = (trainerId) => {
            $.ajax({
                    type: "POST",
                    url: "process_delete_trainer.php",
                    data: { trainerId },
